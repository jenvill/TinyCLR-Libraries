namespace System.Text {
    /// <summary>
    /// A Micro Framework port of the Full Framework FixedStringBuilder. Contributed by Julius Friedman.
    /// </summary>
    public sealed class FixedStringBuilder {
        #region Fields

        int m_MaxCapacity;
        char[] m_ChunkChars;
        int m_ChunkLength;
        FixedStringBuilder m_ChunkPrevious;
        int m_ChunkOffset;
        ...
        /// <summary>
        /// Gets or sets the length of the current FixedStringBuilder object.
        /// </summary>
        public int Length {
        ...
        /// <summary>
        /// Initializes a new instance of the FixedStringBuilder class from the specified substring and capacity.
        /// </summary>
        /// <param name="value"></param>
        /// <param name="startIndex"></param>
        /// <param name="length"></param>
        /// <param name="capacity"></param>
        public FixedStringBuilder(string value, int startIndex, int length, int capacity) {
            if (capacity < 0) {
        ...
        private FixedStringBuilder(int size, int maxCapacity, FixedStringBuilder previousBlock) {
        ...
        /// <summary>
        /// Initializes a new instance of the FixedStringBuilder class using the specified string and capacity.
        /// </summary>
        /// <param name="value"></param>
        /// <param name="capacity"></param>
        public FixedStringBuilder(string value, int capacity)
            : this(value, 0, (value != null) ? value.Length : 0, capacity) { }

        /// <summary>
        /// Initializes a new instance of the FixedStringBuilder class that starts with a specified capacity and can grow to a specified maximum.
        /// </summary>
        /// <param name="capacity"></param>
        /// <param name="maxCapacity"></param>
        public FixedStringBuilder(int capacity, int maxCapacity) {
        ...
        private FixedStringBuilder(FixedStringBuilder from) {
        ...
        /// <summary>
        /// Initializes a new instance of the FixedStringBuilder class using the specified capacity.
        /// </summary>
        /// <param name="capacity"></param>
        ...
        /// <summary>
        /// Initializes a new instance of the FixedStringBuilder class using the specified string.
        /// </summary>
        /// <param name="value"></param>
        public FixedStringBuilder(string value)
            : this(value, 0x10) { }

        /// <summary>
        /// Initializes a new instance of the FixedStringBuilder class.
        /// </summary>
        ...
        /// <summary>
        /// Removes all characters from the current FixedStringBuilder instance.
        /// </summary>
        /// <returns></returns>
        public FixedStringBuilder Clear() {
            this.Length = 0;
            return this;
        }
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public FixedStringBuilder Append(bool value) => this.Append(value.ToString());
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public FixedStringBuilder Append(byte value) => this.Append(value.ToString());
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public FixedStringBuilder Append(char value) {
        ...
        */
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public FixedStringBuilder Append(double value) => this.Append(value.ToString());
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public FixedStringBuilder Append(short value) => this.Append(value.ToString());
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public FixedStringBuilder Append(int value) => this.Append(value.ToString());
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public FixedStringBuilder Append(long value) => this.Append(value.ToString());
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public FixedStringBuilder Append(object value) {
            if (value == null)
                return this;
            return this.Append(value.ToString());
        }

        public FixedStringBuilder Append(string value) {
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public FixedStringBuilder Append(float value) => this.Append(value.ToString());
        ...
        /// <returns></returns>
        [CLSCompliant(false)]
        public FixedStringBuilder Append(ulong value) => this.Append(value.ToString());
        ...
        /// <returns></returns>
        public FixedStringBuilder Append(string value, int startIndex, int count) {
            if (startIndex < 0) {
                throw new ArgumentOutOfRangeException("startIndex");
            }
            if (count < 0) {
        ...
        /// <returns></returns>
        public FixedStringBuilder Append(char[] value, int startIndex, int charCount) {
            if (startIndex < 0) {
                throw new ArgumentOutOfRangeException("startIndex");
            }
            if (charCount < 0) {
        ...
        /// <returns></returns>
        public FixedStringBuilder Append(char value, int repeatCount) {
            if (repeatCount < 0) {
        ...
        /// <param name="length"></param>
        /// <returns></returns>
        public FixedStringBuilder Remove(int startIndex, int length) {
            if (length < 0) {
                throw new ArgumentOutOfRangeException("length");
            }
            if (startIndex < 0) {
        ...
        public override string ToString()
        {
            ...
            do {
                if (chunkPrevious.m_ChunkLength > 0) {
                    ...
                    var target = new char[chunkLength];
                    System.Array.Copy(chunkChars, target, chunkLength);
        ...
        /// <param name="count"></param>
        /// <returns></returns>
        public FixedStringBuilder Insert(int index, string value, int count) {
            if (count < 0) {
                throw new ArgumentOutOfRangeException("count");
            }
        ...
        /// <param name="charCount"></param>
        /// <returns></returns>
        public FixedStringBuilder Insert(int index, char[] value, int startIndex, int charCount) {
            var length = this.Length;
            if (index > length) {
                throw new ArgumentOutOfRangeException("index");
            }
        ...
        /// <param name="count"></param>
        /// <returns></returns>
        public FixedStringBuilder Replace(char oldChar, char newChar, int startIndex, int count) {
            int num3;
            var length = this.Length;
        ...
        /// <param name="newChar"></param>
        /// <returns></returns>
        public FixedStringBuilder Replace(char oldChar, char newChar) => this.Replace(oldChar, newChar, 0, this.Length);
        ...
        /// <param name="count"></param>
        /// <returns></returns>
        public FixedStringBuilder Replace(string oldValue, string newValue, int startIndex, int count) {
            var length = this.Length;
            if (startIndex > length) {
                throw new ArgumentOutOfRangeException("startIndex");
            }
        ...
        /// <param name="newValue"></param>
        /// <returns></returns>
        public FixedStringBuilder Replace(string oldValue, string newValue) => this.Replace(oldValue, newValue, 0, this.Length);

        /// <summary>
        /// Append the provided line along with a new line.
        /// </summary>
        /// <param name="str"></param>
        public FixedStringBuilder AppendLine(string str) {
            this.Append(str);
        ...
        /// </summary>
        public FixedStringBuilder AppendLine() => this.Append(Environment.NewLine);
        ...
        internal bool StartsWith(FixedStringBuilder chunk, int indexInChunk, int count, string value) {
        ...
        internal void ReplaceAllInChunk(int[] replacements, int replacementsCount, FixedStringBuilder sourceChunk, int removeCount, string value) {
        ...
        internal FixedStringBuilder Next(FixedStringBuilder chunk) {
            if (chunk == this) {
                return null;
            }
        ...
        private void ReplaceInPlaceAtChunk(ref FixedStringBuilder chunk, ref int indexInChunk, char[] value, ref int valueIndex, int count) {
            if (count == 0) {
                return;
            }
            while (true) {
        ...
        internal void MakeRoom(int index, int count, out FixedStringBuilder chunk, out int indexInChunk, bool doneMoveFollowingChars) {
            ...
            if ((!doneMoveFollowingChars && (chunk.m_ChunkLength <= 0x20)) && ((chunk.m_ChunkChars.Length - chunk.m_ChunkLength) >= count)) {
                ...
                var builder = new FixedStringBuilder(Math.Max(count, 0x10), chunk.m_MaxCapacity, chunk.m_ChunkPrevious) {
                    m_ChunkLength = count
                };
        ...
        internal FixedStringBuilder FindChunkForIndex(int index) {
            var chunkPrevious = this;
        ...
        internal void ExpandByABlock(int minBlockCharCount) {
            ...
            this.m_ChunkPrevious = new FixedStringBuilder(this);
        ...
        internal void Remove(int startIndex, int count, out FixedStringBuilder chunk, out int indexInChunk) {
            var num = startIndex + count;
            chunk = this;
            FixedStringBuilder builder = null;
            var sourceIndex = 0;
            while (true) {
